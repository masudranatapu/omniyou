    ...
    <div class="sh-headpanel">
        ...
        <div class="sh-headpanel-right">
            ...
            <div class="dropdown dropdown-profile">
                <a href="" data-toggle="dropdown" class="dropdown-link">
                    <img src="{{ asset(Auth::user()->image ?? 'backend/img/profile/default.jpg') }}"
                        class="wd-60 rounded-circle" alt="{{ Auth::user()->name }}">
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <ul class="dropdown-profile-nav">
                        <li><a href="{{ route('admin.profile') }}"><i class="icon ion-ios-person"></i> Edit Profile</a>
                        </li>
                        <li><a href="javascript:void(0)" onclick="$('#logout-form').submit();"><i
                                    class="icon ion-power"></i> Logout</a></li>
