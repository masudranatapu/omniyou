          ...
          <div class="card-body">
              ...
              <div class="row d-flex justify-content-center">
                  @if(count($allOption) != 0)
                      ...
                      <div class="mb-3">
                        <label class="form-control-label">Option {{ $key + 1 }} <span class="tx-danger">*</span></label>
                        <input type="text" name="answer_option[]" class="form-control" placeholder="Enter answer option {{ $key + 1 }}" value="{{ $value->answer_option }}">
                        @error('question')
                    ...
                    @else
                      <div class="col-lg-6">
                          <div class="mb-3">
                            ...
                            <input type="text" name="answer_option[]" class="form-control" placeholder="Enter answer option 1" required>
                            @error('question')
                              <div class="text-danger">{{$message}}</div>
                            @enderror
                          </div>
                          <div class="mb-3">
                            ...
                            <input type="text" name="answer_option[]" class="form-control" placeholder="Enter answer option 2" required>
                            @error('question')
                              <div class="text-danger">{{$message}}</div>
                            @enderror
                          </div>
                          <div class="mb-3">
                            ...
                            <input type="text" name="answer_option[]" class="form-control" placeholder="Enter answer option 3" required>
                            @error('question')
                              <div class="text-danger">{{$message}}</div>
                            @enderror
                          </div>
                          <div class="mb-3">
                            ...
                            <input type="text" name="answer_option[]" class="form-control" placeholder="Enter answer option 4" required>
                            @error('question')
                              <div class="text-danger">{{$message}}</div>
                            @enderror
                          </div>
