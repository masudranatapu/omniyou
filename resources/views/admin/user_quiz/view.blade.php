            ...
            <form action="">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <br>
                                Bangladeshi <input type="radio" name="nationality" value="Bangladeshi" class="mr-3 ml-1"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" name="name" class="form-control" placeholder="Email Address (optional)">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                Daily Worker <input type="radio" name="jobstatus" value="Daily Worker" class="mr-3 ml-1"/>
                                Govt. Job <input type="radio" name="jobstatus" value="Govt. Job" class="mr-3 ml-1"/>
                                Non Govt. Job <input type="radio" name="jobstatus" value="Non Govt. Job" class="mr-3 ml-1"/>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="number" name="name" class="form-control" placeholder="Post Code">
                                    </div>
                                    <div class="col-md-12 mb-3">
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            <div class="col-md-5">
                                <label for="questions1">Do like to engage in dialogues like (identity, community, nationality)?</label>
                            </div>
                            <div class="col-md-7">
