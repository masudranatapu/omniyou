    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-9">
            <div class="box_wrapper question_ans"
                style="background-image: url('{{ asset('frontend/images/1.jpg') }}');background-size: cover; background-position: center;background-repeat: no-repeat;">
                            ...
                            @foreach ($options as $ques)
                                <div class="col-lg-6">
                                    <div class="form-check">
                                        ...
                                        <input type="hidden" value="2" name="step_id">
